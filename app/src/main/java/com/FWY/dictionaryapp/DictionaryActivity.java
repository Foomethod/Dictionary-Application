...
public class DictionaryActivity extends SQLiteOpenHelper{
    ...
    public boolean checkDatabase()
    {
        ...
        try{
            String mypath = "/data/data/com.example.yumak.dictionaryapp/databases/database.db";
    ...
    public void copyDatabase() throws IOException
    {
        ...
        String outfilename = "/data/data/com.example.yumak.dictionaryapp/databases/database.db";
